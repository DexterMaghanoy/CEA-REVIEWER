...
if (isset($_GET['program_id']) || isset($_GET['quiz_type'])) {
    ...
    $program_id = isset($_SESSION['program_id']);
    $quiz_type = 1;
                                ...
                                <div class="card subject-<?php echo ($index % 3) + 1; ?> mb-1">
                                    <div class="card-body" style="padding: 0.5rem;">
                                        ...
                                        <p style="font-size: 0.8rem; margin-bottom: 0;">Student who answered:
                                            <?php
                                            $stmtAnswered = $conn->prepare("SELECT COUNT(DISTINCT stud_id) AS answered FROM tbl_result WHERE course_id = :course_id AND quiz_type = $quiz_type");
