                    ...
                    <div class="col-md-5">
                        <form action="edit_question.php" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <div id="answerValidationMessage" style="color: red; display: none;">Answer cannot be just spaces.</div>
                            </div>

                            <script>
                                document.getElementById("question_answer").addEventListener("input", function() {
                                    var answer = this.value.trim();
                                    if (answer.length === 0) {
                                        document.getElementById("answerValidationMessage").style.display = "block";
                                    } else {
                                        document.getElementById("answerValidationMessage").style.display = "none";
                                    }
                                });
                            </script>
