...
$session_program_id = $_SESSION['program_id'];
...
if (isset($_POST['save'])) {
    $program_id = $_POST['program_id']; // Fetch the program_id from the form
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="program_id" name="program_id" required>
                                <?php foreach ($programs as $program) : ?>
                                    <option value="<?php echo htmlspecialchars($program['program_id']); ?>" <?php echo ($program['program_id'] == $session_program_id) ? 'selected' : ''; ?>>
