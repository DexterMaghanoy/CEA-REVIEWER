            ...
            <div class="row justify-content-center mt-2">
                ...
                <div class="col-md">
                    ...
                    <script>
                        ...
                        const yValues = <?php echo json_encode(array_map(function ($quiz_count) {
                                            return $quiz_count !== 0 ? 100 / $quiz_count : 0; // Avoid division by zero
                                        }, array_column($courses, 'quiz_count')));
                                        "%" ?>;

                        // Define a function to generate colors dynamically based on data
                        function generateColors(data) {
                            const colors = [];
                            data.forEach((value, index) => {
                                // Assign color based on some condition, here I'm assigning colors randomly
                        ...
                        const barColors = generateColors(yValues);
                                ...
                                plugins: {
                                    datalabels: {
                                        ...
                                        formatter: (value, ctx) => {
                                            ...
                                            // Display course code and percentage
