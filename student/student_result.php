...
if (isset($_SESSION['stud_id']) && isset($_GET['course_id'])) {
    ...
    $sql = "SELECT tbl_result.result_score, tbl_result.total_questions, tbl_module.module_number, tbl_module.module_name
            FROM tbl_result
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered border-secondary">
                                ...
                                <tbody>
                                    ...
                                    <?php else : ?>
                                        <tr>
                                            <td colspan="4" class="text-center">You did not answer pa.</td>
                                        </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
