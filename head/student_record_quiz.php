...
if (!$stud_id) {
    ...
    $sql = "SELECT tbl_result.*, tbl_module.module_name, tbl_result.created_at
            ...
            WHERE tbl_result.stud_id = :stud_id AND tbl_result.program_id = :program_id AND tbl_result.quiz_type = 2";
                ...
                <div class="row justify-content-center mt-2">
                    <div class="col-md-12">
                        <div class="text-center mb-4">
                            ...
                            <h1>QUIZ Results: <span style="font-weight: normal;"><?php echo $student_details['stud_fname'] . " " . $student_details['stud_lname'] ?></span></h1>
