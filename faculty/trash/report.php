...
if(isset($_SESSION['user_id'])){
    ...
    if (!empty($search)) {
        $sql .= " WHERE (s.stud_fname LIKE :search OR s.stud_lname LIKE :search OR c.course_name LIKE :search OR m.module_name LIKE :search)";
    }
                ...
                <div class="table-responsive">
                    <table class="table table-bordered border-secondary">
                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="3" class="text-center">No records found for students.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
