...
<head>
    ...
    <style>
        ...
        .card-header {
            ...
            /* background: linear-gradient(to right, rgba(21, 150, 55, 0.5), rgba(175, 200, 120, 0.4)); */

            background: linear-gradient(to right, rgba(95, 252, 95, 0.5), rgba(125, 255, 175, 0.5));
